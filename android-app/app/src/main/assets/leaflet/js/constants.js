...
const statusPalette = {
    'A': '#d7263d',
    'P': '#2a9d8f',  // treated same as N on map
    'N': '#2a9d8f',
    ' ': '#4d6a77',
};
...
// Threat rendering constants
const THREAT_DIRECTION_MIN_DISTANCE_METERS = 10000;
...
const THREAT_DIRECTION_BASE_LINE_WEIGHT = 2.5;
const THREAT_DIRECTION_MIN_LINE_WEIGHT = 1.5;
const THREAT_DIRECTION_MAX_LINE_WEIGHT = 3.5;
const THREAT_DIRECTION_BASE_ARROW_LENGTH_PX = 12;
const THREAT_DIRECTION_MIN_ARROW_LENGTH_PX = 8;
const THREAT_DIRECTION_MAX_ARROW_LENGTH_PX = 16;
const THREAT_DIRECTION_BASE_ARROW_WIDTH_PX = 6;
const THREAT_DIRECTION_MIN_ARROW_WIDTH_PX = 4;
const THREAT_DIRECTION_MAX_ARROW_WIDTH_PX = 9;
const THREAT_MARKER_TAP_TARGET_PX = 40;

// Threat popup constants
